...
// â”€â”€ Web Push helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#1a1f2e;border-radius:16px;overflow:hidden;border:1px solid #2d3748;">
        <tr><td style="background:linear-gradient(135deg,#6366f1,#8b5cf6);padding:28px 32px;">
          <p style="margin:0;font-size:22px;font-weight:700;color:#fff;">ðŸ“© New Message</p>
        ...
        <tr><td style="padding:32px;">
          ...
          <a href="${chatUrl}" style="display:inline-block;background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff;text-decoration:none;padding:14px 28px;border-radius:10px;font-size:14px;font-weight:600;">Reply Now â†’</a>
        </td></tr>
...
<body style="margin:0;padding:0;background:#0f1117;font-family:Inter,sans-serif;color:#f1f5f9;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0f1117;padding:40px 20px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#1a1f2e;border-radius:16px;overflow:hidden;border:1px solid #2d3748;">
        <tr><td style="background:linear-gradient(135deg,#6366f1,#8b5cf6);padding:28px 32px;">
          <p style="margin:0;font-size:22px;font-weight:700;color:#fff;">ðŸ’¬ ${adminName} replied</p>
        ...
        <tr><td style="padding:32px;">
          ...
          <a href="${chatUrl}" style="display:inline-block;background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff;text-decoration:none;padding:14px 28px;border-radius:10px;font-size:14px;font-weight:600;">View Reply â†’</a>
        </td></tr>
        <tr><td style="padding:20px 32px;border-top:1px solid #2d3748;">
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#1a1f2e;border-radius:16px;overflow:hidden;border:1px solid #2d3748;">
        <tr><td style="background:linear-gradient(135deg,#ef4444,#dc2626);padding:28px 32px;">
          <p style="margin:0;font-size:22px;font-weight:700;color:#fff;">ðŸ“µ Missed ${callType} Call</p>
        ...
        <tr><td style="padding:32px;">
          ...
          <a href="${chatUrl}" style="display:inline-block;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;text-decoration:none;padding:14px 28px;border-radius:10px;font-size:14px;font-weight:600;">Open Chat â†’</a>
        </td></tr>
        <tr><td style="padding:20px 32px;border-top:1px solid #2d3748;">
          <p style="margin:0;font-size:12px;color:#64748b;">Email alert from your portfolio chat.</p>
        </td></tr>
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (record.status === "missed" || record.status === "declined") {
      ...
      if (receiverProfile?.email) {
        await sendEmail(
          ...
          `ðŸ“µ Missed ${call_type} call from ${callerName}`,
      ...
      await supabase.from("notifications").insert({
        user_id: receiver_id,
        type: "missed_call",
        title: `ðŸ“µ Missed ${call_type} call`,
    ...
    const preview = content
      ? content.slice(0, 200)
      : type === "image" ? "ðŸ“· Sent an image"
        : type === "file" ? "ðŸ“Ž Sent a file"
          : "New message";
    ...
    if (isAdminSender) {
      // Admin â†’ client: Web Push + email + in-app notification

...
import { seoEvents } from "@/lib/analytics";
...
export const Route = createFileRoute("/")({
  head: () => {
    const seoData = generateSEOMeta({
      ...
      description: "Ajibola Gbenga Joseph is a professional website designer and website developer for hire. I build custom websites, landing pages, and e-commerce sites that look sharp, load fast, and turn visitors into paying clients.",
      keywords: [
      ...
      schema: [
        {
          ...
          "@type": "WebPage",
          name: "Website Designer & Website Developer for Hire | Ajibola Gbenga Joseph",
          url: `${SITE_URL}/`,
          description: "Professional website designer and website developer for hire. Custom websites, landing pages, e-commerce sites and web apps that convert visitors into clients.",
          inLanguage: "en",
          isPartOf: { "@type": "WebSite", url: `${SITE_URL}/` },
          about: SCHEMA_TEMPLATES.person,
          ...
          breadcrumb: SCHEMA_TEMPLATES.breadcrumb([
          ...
          mainEntity: {
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "What does a professional website designer do?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "A professional website designer creates custom, conversion-focused websites that look great, load fast, and turn visitors into clients. This includes design, development, SEO optimization, and ongoing support."
                }
              },
              {
                "@type": "Question",
                name: "How much does it cost to hire a website designer?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Website design costs vary based on complexity. Basic business websites start from $500, while custom e-commerce sites begin at $1,500. Contact for a detailed quote based on your specific needs."
                }
              }
            ]
          }
    ...
    const obs = new IntersectionObserver(
      (entries) => entries.forEach((e) => {
        if (e.isIntersecting) {
          ...
          // Track section visibility for SEO analytics
          const sectionName = e.target.getAttribute('data-section') || 'unknown';
          seoEvents.servicePageView(sectionName);
        }
      }),
      { threshold: 0.12 }
    );

...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ajibola-gbenga-joseph.onrender.com/" },
      { property: "og:image", content: "https://ajibola-gbenga-joseph.onrender.com/me.webp" },
      ...
      { name: "twitter:image", content: "https://ajibola-gbenga-joseph.onrender.com/me.webp" },
    ...
    links: [
      ...
      { rel: "canonical", href: "https://ajibola-gbenga-joseph.onrender.com/" },
    ...
    scripts: [
      // Person schema
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://ajibola-gbenga-joseph.onrender.com/me.webp",

...
import { FaTiktok, FaThreads, FaInstagram } from "react-icons/fa6";
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-3xl border border-border bg-card p-8 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              {[
                { icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/gbengajosephajibola", color: "hover:border-pink-500/40" },
